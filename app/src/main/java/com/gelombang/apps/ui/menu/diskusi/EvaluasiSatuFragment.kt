...
import com.gelombang.apps.databinding.FragmentEvaluasiSatuBinding
...
class EvaluasiSatuFragment : Fragment() {
    companion object {
        const val TYPE = "TYPE"
        const val DATA = "DATA"
        const val NAME = "NAME"
    }
    private var uri = arrayOfNulls<Uri>(8)
    private var images = arrayOfNulls<ImageView>(8)
    ...
    override fun onCreateView(
        ...
        val binding:FragmentEvaluasiSatuBinding = FragmentEvaluasiSatuBinding.inflate(layoutInflater)
        ...
        if (type.equals("guru")) {
            ...
            showDialog(activity!!)
            val pathReference:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "0.jpg")
            pathReference.downloadUrl.addOnSuccessListener { uri ->
                ...
                val pathReference1:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "1.jpg")
                pathReference1.downloadUrl.addOnSuccessListener { uri1 ->
                    ...
                    val pathReference2:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "2.jpg")
                    pathReference2.downloadUrl.addOnSuccessListener { uri2 ->
                        ...
                        val pathReference3:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "3.jpg")
                        pathReference3.downloadUrl.addOnSuccessListener { uri3 ->
                            ...
                            val pathReference4:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "4.jpg")
                            pathReference4.downloadUrl.addOnSuccessListener { uri4 ->
                                ...
                                val pathReference5:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "5.jpg")
                                pathReference5.downloadUrl.addOnSuccessListener { uri5 ->
                                    ...
                                    val pathReference6:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "6.jpg")
                                    pathReference6.downloadUrl.addOnSuccessListener { uri6 ->
                                        ...
                                        val pathReference7:StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child(hasilEvaluasi?.key + "7.jpg")
                                        pathReference7.downloadUrl.addOnSuccessListener { uri7 ->
                                            displayImageOriginal(
                                                activity!!,
                                                images[7],
                                                uri7,
    ...
    private fun sendAnswer(
        ...
        showDialog(activity!!)
        val key: String? = mDatabase!!.child("PertemuanSatu").push().key
        for (x: Int in imageUri.indices) {
            val path: StorageReference = storageRef!!.child("Diskusi").child("PertemuanSatu").child("$key$x.jpg")
            ...
            uploadTask.addOnSuccessListener {
                if (x == imageUri.size - 1) {
                    ...
                    maps["status"] = "0"
                    maps["nilai"] = ""
                    mDatabase!!.child("PertemuanSatu").child(key!!).setValue(maps)
